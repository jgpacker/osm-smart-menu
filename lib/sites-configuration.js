...
const Sites = {
  ...
  bingmaps: {
    link: "www.bing.com/maps", //TODO: is this a problem? it helps avoid misidentifying bing search pages as maps
    paramOpts: [
  ...
  stamen: {
    ...
    paramOpts: [
      ...
      {ordered:"/#watercolor/{zoom}/{lat}/{lon}"}, //this url and the two below are not separated into different objects because they are only here to be recognized instead of being a target
  ...
  opensciencemap: {
    ...
    paramOpts: [
      {ordered:"/#", unordered: {zoom:"scale", lat:"lat", lon: "lon"}}
    ]
    //TODO: review this site, because it's really buggy
    //original link: http://opensciencemap.org/map/#&scale=17&rot=0&tilt=0&lat=-26.253&lon=-48.854
  },
  ...
  idlatest: {
    ...
    paramOpts: [
      {ordered:"/background=Bing&map=#{zoom}/{lat}/{lon}"} //TODO: /#background=Bing&map=15.16/-71.8578/19.6509   (note that the zoom is a decimal number)
    ]
  },
  ...
  osminspector: { // There are more tools http://tools.geofabrik.de/
...
*/
  ...
  //Mapillary: uses bounding box points, so I need to figure out how to transform this into zoom/lat/lon http://www.mapillary.com/map/im/bbox/26.511133424214552/27.23021032948516/13.055877685546875/14.931793212890625
...
/*
  josm: {
    link: "localhost:8111",
    paramOpts: [
      {ordered:"/load_and_zoom", unordered: {minLon:"left", minLat:"bottom", maxLon:"right", maxLat:"top"}} //TODO: that's not supported yet... mapillary may have something similar
    ]
  },
